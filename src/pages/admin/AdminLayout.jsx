...
import { FiMenu, FiX, FiChevronLeft, FiChevronRight, FiBox } from "react-icons/fi";
...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className={`hidden md:block fixed top-0 left-0 bottom-0 z-40 ${collapsed ? "w-20" : "w-64"}`}>
        <Sidebar
          collapsed={collapsed}
          mobile={false}
          onClose={() => {}}
        ...
        <div className="flex items-center justify-between px-3 py-2">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-semibold">MN Konveksi</div>
                <div className="text-xs text-gray-500">Admin Panel</div>
              </div>
            </div>
          </div>

          <button onClick={handleLogout} className="p-2 rounded-md hover:bg-gray-100" title="Logout" aria-label="Logout">
            <FiX />
          </button>
        </div>
      </header>
      ...
      {/* main content */}
      <div className={`${mdMarginClass} transition-all duration-200 min-h-screen bg-slate-50`}>
